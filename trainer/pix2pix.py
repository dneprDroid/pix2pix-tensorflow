...
# parser.add_argument("--input_dir", default='facades/val', help="path to folder containing images")
...
parser.add_argument("--save_freq", type=int, default=400, help="save model every save_freq steps, 0 to disable")
